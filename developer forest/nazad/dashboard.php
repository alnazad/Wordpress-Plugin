...
<div class="container-fluid" style="margin-top: 50px; ">
  <div class="row">
    <div class="col-md-6">
      ...
      <h1 style="text-align: center;background:green;color:white;padding-bottom:10px">Total Wastage Report</h1>
      <?php
      global $wpdb;
      $mw = $wpdb->prefix . "material_wastage";
      $rm = $wpdb->prefix . "raw_materials";
      ...
      <script type="text/javascript">
        ...
        <div id="piechart_3d" style="width:150%; height: 500px;margin-left:-15%" ></div>
