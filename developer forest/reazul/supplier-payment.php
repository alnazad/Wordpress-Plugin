...
<div class="container">
    <div class="row">
        <div class="col-12">
        <h1 style="text-align: center; background-color:aqua; padding: 10px; ">Supplier Payment List</h1><br><br>


<a class="btn btn-primary" href="<?php echo esc_url(admin_url('admin.php?page=re_insert')) ?>">Add Supplier Payment</a><br><br>
